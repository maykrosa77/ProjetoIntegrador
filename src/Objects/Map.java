...
public class Map extends Sprite{
	...
	private Rectangle2D[] bases;
	private Rectangle2D[] battlefields;
    ...
    */
	public Map(BufferedImage image, int x, int y, Rectangle2D[] bases, Rectangle2D[] battlefields, Scene parent){
		terrain =  image;
    ...
    */
	...
	public void render(Graphics2D graphics) {
		...
		for(Rectangle2D b : battlefields)
			graphics.fillRect((int)b.getX(), (int)b.getY(), (int)b.getWidth(), (int)b.getHeight());
	}
